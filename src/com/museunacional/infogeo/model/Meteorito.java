...
public class Meteorito {
	...
	public String getData() {
		...
		case 10:
			return ano.substring(8) + "/" + ano.substring(5, 7) + "/"
					+ ano.substring(0, 4);
		default:
			return null;
		}
	...
	public boolean contains(String s) {
		...
		return nome.toLowerCase().contains(s2) || uf.toLowerCase().contains(s2)
				|| (ano != null ? ano.contains(s2) : false);
	}
